...
Trata-se de um aplicativo multi-páginas (_MPA_) de lista de compras.

O usuário tem acesso a três páginas:

1. Página principal: possui um resumo dos itens cadastrados em forma de lista em grid;
